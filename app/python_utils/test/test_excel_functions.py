...
class TestExcelFunctions(unittest.TestCase):
    ...
    def test_write_and_read_excel(self):
        ...
        file_path = r'D:\repos\current\python-utility-functions\local_test\example.xlsx'
        
        # Define headers and data to be written to the Excel file
        headers = ['name', 'age', 'score']
        scores = [
            {'name': 'ankit', 'age': 12, 'score': 1000},
            {'name': 'rahul', 'age': 13, 'score': 100},
            {'name': 'priya', 'age': 12, 'score': 300},
            {'name': 'harshita', 'age': 12, 'score': 50},
        ]
