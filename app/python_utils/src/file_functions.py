...
class FileRenamer:
    ...
    def rename_file(self, old_name, new_name):
        ...
        try:
            ...
            logger.error(f"Error renaming '{old_name}' to '{new_name}': {str(e)}")
            raise SystemError("Error renaming '{old_name}' to '{new_name}'.")
    ...
    def rename_files(self):
        ...
        logger.info(f"Renamed all files in {self.path}")
